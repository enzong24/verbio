...
export default function DuelInterface({
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      <div className="border-b border-card-border bg-card p-3 md:p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 md:gap-4">
          ...
          <div className="flex flex-col items-center flex-shrink-0">
            <div className="flex items-center gap-1 md:gap-2 mb-1">
              ...
              <span className={`font-mono font-bold text-base md:text-lg ${timeLeft <= 10 ? 'text-destructive' : ''}`} data-testid="text-timer">
                {timeLeft}s
              </span>
            </div>
      ...
      <div className="flex-1 overflow-hidden">
        <div className="max-w-7xl mx-auto h-full flex flex-col md:flex-row">
          <div className="flex-1 flex flex-col min-h-0">
            <div className="p-3 md:p-4 border-b border-card-border bg-card/50">
              <div className="flex items-center gap-2 mb-2">
                <span className="font-semibold text-sm md:text-base">Topic:</span>
                <Badge variant="outline" className="text-xs md:text-sm">{topic}</Badge>
              </div>
            ...
            <div className="p-3 md:p-4 border-t border-card-border bg-card">
              ...
              {validationError && (
                <div className="mb-2 p-2 rounded-md bg-destructive/10 border border-destructive/20 text-destructive text-xs md:text-sm" data-testid="validation-error">
                  {validationError}
                </div>
              )}
          ...
          <div className="hidden md:block md:w-80 border-l border-card-border bg-card/50 p-6">
