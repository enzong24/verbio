// Firebase login page (from blueprint:firebase_barebones_javascript)
import { useEffect, useState } from "react";
import { signInWithGoogle, handleRedirectResult } from "@/lib/firebaseAuth";
...
export default function FirebaseLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background" data-testid="page-firebase-login">
