...
- **Practice vs. Competitive Modes**: Practice mode offers perfect AI bots with no Fluency Score changes, while Competitive mode applies full Fluency Score changes even against bots. **Practice matches are excluded from competitive analytics**: Practice matches do not affect skill progress calculations and are not included in Focus Areas analysis, but they do appear in Recent Matches with a "Practice" badge so users can review AI feedback. Premium AI feedback is fully functional in practice mode for premium users.
