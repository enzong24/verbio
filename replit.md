...
- **Forfeit Behavior**: 
  ...
  - **Forfeit UI Display**: MatchResults checks `isForfeit` flag and displays a simple "Match ended by forfeit" message while hiding all score details (both performance breakdown and score comparison) when match is forfeited
