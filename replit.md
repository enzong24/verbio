...
- **Competitive Bot Matches**: Bots have varied stats and Fluency Scores (Beginner: 600-800, Easy: 800-1000, Medium: 1100-1300, Hard: 1300-1600). **Bot target accuracy ranges**: Beginner: 40-52%, Easy: 55-67%, Medium: 68-78%, Hard: 82-92%. These non-overlapping ranges ensure clear scoring differentiation between difficulty levels.
